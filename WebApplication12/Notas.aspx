<%@ Page Title="Notas" Language="C#" MasterPageFile="~/Site.Master"
         AutoEventWireup="true" CodeBehind="Notas.aspx.cs" Inherits="CAPAS_Web.Notas" %>

<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    <div class="mb-3">
        <h4><i class="bi bi-journal-text me-2"></i>Notas</h4>
    </div>
    ...
    <div class="card shadow-sm border-0 mb-4">
        <div class="card-body p-3">
            ...
            <asp:DropDownList ID="ddlAlumno" runat="server" CssClass="form-select"
                               AutoPostBack="true" OnSelectedIndexChanged="ddlAlumno_Changed"/>
        </div>
    </div>
